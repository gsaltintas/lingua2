#!/usr/bin/env bash
# bash apps/main/configs/modular_arithmetic/create_and_submit_zero_padded_tokenizers.sh
ROOT_DIR="apps/main/configs/modular_arithmetic/modular_arithmetic_zero_padded"
BASE_CONFIG="apps/main/configs/modular_arithmetic/base.yaml"
...
dump_dir: /fsx/craffel/lingua_logs/modular_arithmetic_zero_padded/${safe_name}
